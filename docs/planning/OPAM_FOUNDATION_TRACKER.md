...
- [ ] `aws-eio` after current engineer's OPAM work lands
...
Track `https-eio` PR #30570 and `kafka-eio` PR #30557 through opam-repository CI/review. Rejoin `aws-eio` after its active OPAM metadata work settles.
