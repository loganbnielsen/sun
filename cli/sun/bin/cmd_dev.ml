...
(* Delegate to shared module — see Sun_cli_port_forward for the resolution logic. *)
...
type pf_spec = Sun_cli_port_forward.pf_spec = {
  name        : string;
  namespace   : string;
  target      : string;
  local_port  : int;
...
let start_port_forward = Sun_cli_port_forward.start_port_forward_spec
let stop_port_forwards = Sun_cli_port_forward.stop_port_forwards
