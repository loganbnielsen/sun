...
(* ── Template aliases (all template strings live in Sun_cli_scaffold_templates) ── *)

let tpl_ocamlformat     = Sun_cli_scaffold_templates.tpl_ocamlformat
let tpl_dune_project    = Sun_cli_scaffold_templates.tpl_dune_project
let tpl_readme          = Sun_cli_scaffold_templates.tpl_readme
let tpl_sun_toml        = Sun_cli_scaffold_templates.tpl_sun_toml
let tpl_github_ci       = Sun_cli_scaffold_templates.tpl_github_ci
let tpl_github_deploy   = Sun_cli_scaffold_templates.tpl_github_deploy
let tpl_dockerfile      = Sun_cli_scaffold_templates.tpl_dockerfile
let tpl_dockerignore    = Sun_cli_scaffold_templates.tpl_dockerignore
let ws_charged_ml       = Sun_cli_scaffold_templates.ws_charged_ml
let ws_events_dune      = Sun_cli_scaffold_templates.ws_events_dune
let ws_notification_ml  = Sun_cli_scaffold_templates.ws_notification_ml
let ws_storage_dune     = Sun_cli_scaffold_templates.ws_storage_dune
let ws_svc_handler_ml   = Sun_cli_scaffold_templates.ws_svc_handler_ml
let ws_svc_lib_dune     = Sun_cli_scaffold_templates.ws_svc_lib_dune
let ws_svc_bin_ml       = Sun_cli_scaffold_templates.ws_svc_bin_ml
let ws_svc_bin_dune     = Sun_cli_scaffold_templates.ws_svc_bin_dune
let ws_worker_ml        = Sun_cli_scaffold_templates.ws_worker_ml
let ws_worker_lib_dune  = Sun_cli_scaffold_templates.ws_worker_lib_dune
let ws_worker_bin_ml    = Sun_cli_scaffold_templates.ws_worker_bin_ml
let ws_worker_bin_dune  = Sun_cli_scaffold_templates.ws_worker_bin_dune
let ws_migration_sql    = Sun_cli_scaffold_templates.ws_migration_sql
let ws_migration_down_sql = Sun_cli_scaffold_templates.ws_migration_down_sql
let ws_test_schemas_ml  = Sun_cli_scaffold_templates.ws_test_schemas_ml
let ws_test_dune        = Sun_cli_scaffold_templates.ws_test_dune
let svc_handler_ml      = Sun_cli_scaffold_templates.svc_handler_ml
let svc_lib_dune        = Sun_cli_scaffold_templates.svc_lib_dune
let svc_bin_ml          = Sun_cli_scaffold_templates.svc_bin_ml
let svc_bin_dune        = Sun_cli_scaffold_templates.svc_bin_dune
let worker_lib_ml       = Sun_cli_scaffold_templates.worker_lib_ml
let worker_lib_dune     = Sun_cli_scaffold_templates.worker_lib_dune
let worker_bin_ml       = Sun_cli_scaffold_templates.worker_bin_ml
let worker_bin_dune     = Sun_cli_scaffold_templates.worker_bin_dune
let fn_lib_ml           = Sun_cli_scaffold_templates.fn_lib_ml
let fn_lib_dune         = Sun_cli_scaffold_templates.fn_lib_dune
let fn_bin_ml           = Sun_cli_scaffold_templates.fn_bin_ml
let fn_bin_dune         = Sun_cli_scaffold_templates.fn_bin_dune
let event_ml            = Sun_cli_scaffold_templates.event_ml
